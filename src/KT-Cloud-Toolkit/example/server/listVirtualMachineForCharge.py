...
# simple example
# print(server.listVirtualMachineForCharge(zone='KR-M')) #View usageplantype of All VM
print(server.listVirtualMachineForCharge(zone='KR-M', \
    vmid='47d2ea4c-d434-418b-a854-c99054abeff7')) # View usageplantype of Selected VM