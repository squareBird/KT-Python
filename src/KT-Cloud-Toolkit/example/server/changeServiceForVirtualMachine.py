...
# simple example
print(server.changeServiceForVirtualMachine(zone='KR-M', \
   vmid='47d2ea4c-d434-418b-a854-c99054abeff7', \
   serviceofferingid='dfd1a951-726b-4ac7-955f-5419554844c9')) #1VCore 2GB
   # serviceofferingid='b1abfccf-5fbb-4eeb-be6f-c892572a06f5')) #2vcore 2GB

# MUST search combinations of serviceofferingid, templateid and productid 
#   in listavailableproducttypesresponse exactly 
